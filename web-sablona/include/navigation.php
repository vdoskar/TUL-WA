...
$user_display = !empty($_SESSION['user_nickname']) ? $_SESSION['user_nickname'] : 'nepřihlášen';
    ...
    <div class="container px-5">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="userRegistrationForm.php">Registrace</a>
                </li>

                <?php if (isset($_SESSION['user_nickname'])) { ?>
                    <li class="nav-item"><a class="nav-link" href="bookInsertForm.php">Přidat knihu</a></li>
                    <li class="nav-item"><a class="nav-link" href="bookView.php">Zobrazit knihy</a></li>
                ...
                <li class="nav-item">
                    <span class="nav-link text-<?php echo isset($_SESSION['user_nickname']) ? 'success' : 'danger'; ?>">
